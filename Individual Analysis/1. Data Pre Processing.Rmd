...
## 4. household data and flag miskin
...
# Ensure the data is in a character format first
...
# Convert to a factor and order the levels.
...
# list of variables with values 1 = Yes, 5 = No.
yes_no_vars <- c(
...
# Loop to recode variables that only have 'Yes' and 'No'
